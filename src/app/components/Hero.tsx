      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div 
              ...
              className="flex flex-col text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6"
            >
        ...
        >
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold mb-2">Summer Programs</h3>
              <p className="text-gray-600">Find enriching summer experiences</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">Discover real-world opportunities</p>
            </div>
          </div>
        </motion.div>
      </div>
