    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="max-w-4xl mx-auto bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 md:p-12 shadow-lg hover:shadow-xl transition-shadow duration-300"
        >
          <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-6 text-center">
            Our Vision
          </h2>
          <p className="text-lg md:text-xl text-blue-800 leading-relaxed text-center">
