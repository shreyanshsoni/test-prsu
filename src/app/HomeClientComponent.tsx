...
type TabId = 'dashboard' | 'search' | 'saved' | 'checklist' | 'goals' | 'roadmapPlanner' | 'customUserProfile';
            ...
            <main className="flex-1 overflow-y-auto p-4 lg:p-6">
              <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-light-card dark:bg-dark-card rounded-lg shadow-sm dark:shadow-dark-border/30 p-6 mb-6">
                  ...
                  {activeTab === 'customUserProfile' && (
                    <section>
                      {/* This should never be displayed since we now navigate directly */}
