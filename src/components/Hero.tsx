    ...
    <section className="relative min-h-screen pt-20 pb-16 md:pt-32 md:pb-24 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div 
              ...
              className="flex flex-col text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 text-light-text dark:text-dark-text"
            >
            ...
            <motion.p 
              ...
              className="text-xl text-light-muted dark:text-dark-muted mb-10"
            >
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto mt-24"
        >
          <div className="bg-light-card dark:bg-dark-card rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold mb-2 text-light-text dark:text-dark-text">Summer Programs</h3>
              <p className="text-light-muted dark:text-dark-muted">Find enriching summer experiences</p>
            </div>
          </div>
          ...
          <div className="bg-light-card dark:bg-dark-card rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold mb-2 text-light-text dark:text-dark-text">Internships</h3>
              <p className="text-light-muted dark:text-dark-muted">Discover real-world opportunities</p>
            </div>
          </div>
        </motion.div>
      </div>
